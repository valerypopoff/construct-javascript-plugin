...
function GetPluginSettings()
{
	return {
		...
		"version":		"0.6.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
...
AddCondition(0, cf_none, "Compare Function Return value", "General", "{0} {1} function {2} ({...})", "Call JS function and compare its return value (does NOT store return value).", "C2CompareFunctionReturnValue");
...
AddCondition(5, cf_none, "Compare alias Call", "Aliases", "{0} {1} [{2}] ({...})", "Call JS function behind the alias expression and compare its return value (does NOT store return value).", "C2CompareAliasCallReturnValue");
...
AddExpression(4, ef_return_any | ef_variadic_parameters, "FunctionReturnValue", "General", "FunctionReturnValue", "Call JS function with optional parameters and get its return value right away (it will NOT store this value).");

AddStringParam("Alias expression", "Enter alias expression."
, ""
);	

AddExpression(2, ef_return_any, "AliasValue", "Aliases", "AliasValue", "Get alias value");

AddStringParam("Alias expression", "Enter alias expression."
, ""
);	

AddExpression(3, ef_return_any | ef_variadic_parameters, "AliasCallReturnValue", "Aliases", "AliasCallReturnValue", "Call the function behind alias expression with optional parameters and get its return value right away (it will NOT store this value).");
